...
<head>
    ...
    <title>Pesan jadwal service</title>
</head>
        ...
        <div class="uk-margin">
            <form class="uk-form-stacked" action="#" method="POST" <?php if(isset($_POST['tanggal'])){ echo "hidden";}else{} ?>>
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <!-- Menghapus atribut min dan max -->
                        <input class="uk-input" id="form-stacked-text" type="date" name="tanggal" required>
                    </div>
                </div>
                <?php
            ...
            <form class="uk-form-stacked" action="action/act_pesan_jadwal.php" method="post" <?php if(isset($_POST['tanggal'])){}else{ echo "hidden";} ?>>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <!-- Menghapus atribut min dan max -->
                        <input class="uk-input" id="form-stacked-text" type="date" name="tanggal" value="<?php if(isset($_POST['tanggal'])){ echo $_POST['tanggal'];}else{ echo'';} ?>" readonly required>
                    </div>
                </div>
